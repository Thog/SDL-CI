...
async function main() {
    ...
    generatedMarkdown += `Commit range: [${commitFrom}..${commitTo}](https://github.com/libsdl-org/SDL/compare/${commitFrom}...${commitTo})\n\n`;
...
function formatCommit(change, isChild) {
    ...
    const linkSha = `[${change.sha.slice(0, 8)}](https://github.com/libsdl-org/SDL/commit/${change.sha})`
